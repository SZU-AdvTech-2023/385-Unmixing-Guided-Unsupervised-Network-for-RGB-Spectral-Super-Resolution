...
class Network(nn.Module):
    ...
    def forward(self, Input_1, Input_2):
        ...
        self.abundance_hsi, self.abundance_RGB, self.hrhsi, self.RGB, self.pred_hrhsi, self.pred_hrhsi_before, self.pred_hrhsi_after = self.gene(Input_1, Input_2)
        ...
        return self.abundance_hsi, self.abundance_RGB, self.hrhsi, self.RGB, self.pred_hrhsi, self.dis_hsi2, self.dis_pre2, self.pred_hrhsi_before, self.pred_hrhsi_after
...
class Generator(nn.Module):
    ...
    def forward(self, hsi, RGB):
        ...
        return self.abundance_hsi, self.abundance_RGB, self.hrhsi1, self.RGB1, self.pred_hrhsi1, self.pred_hrhsi_hat, self.pred_hrhsi
...
if __name__ == "__main__":
    model = Network(20, 31, 3)
    input1 = torch.randn(1, 512, 217, 31)
    input2 = torch.randn(1, 256, 256, 3)
